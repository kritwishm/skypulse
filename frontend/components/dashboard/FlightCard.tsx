      ...
      >
        ...
        <div className="flex items-center justify-between mb-2 sm:mb-3">
          <div className="flex items-center gap-2 sm:gap-3">
            <span className="text-xl sm:text-2xl font-bold text-slate-100 tracking-wide">
              {flight.origin}
            </span>
            <Plane className="h-3.5 w-3.5 sm:h-4 sm:w-4 text-blue-400/70 rotate-[-30deg]" />
            <span className="text-xl sm:text-2xl font-bold text-slate-100 tracking-wide">
              {flight.destination}
            </span>
          </div>
        ...
        {/* Meta tags */}
        <div className="flex items-center gap-1 sm:gap-1.5 text-[10px] sm:text-[11px] text-slate-500 mb-3 sm:mb-4 flex-wrap">
          ...
          {isChecking ? (
            ...
            <div>
              ...
              {result.cheapest_date && flight.departure_date_end && (
                <p className="text-center text-[11px] sm:text-xs text-blue-400/80 mb-1">
              ...
              {/* Best option detail */}
              {cheapestLeg && (
                <div className="flex items-center justify-center gap-1.5 sm:gap-2 text-[11px] sm:text-xs text-slate-500 mb-2 sm:mb-3">
                  {cheapestLeg.airline && (
              ...
              {/* Price range bar */}
              <div className="rounded-lg bg-slate-800/40 p-2.5 sm:p-3 space-y-1.5 sm:space-y-2">
                ...
                <div className="relative h-1 sm:h-1.5 rounded-full bg-slate-700/40 overflow-hidden">
              ...
              {hasBudget && budgetDiff !== null && (
                <div className="mt-1.5 sm:mt-2 rounded-lg bg-slate-800/40 px-2.5 sm:px-3 py-1.5 sm:py-2 flex items-center justify-between">
            ...
            <div className="text-center">
              ...
              <p className="text-[11px] sm:text-xs text-slate-600 mt-1">Last known price</p>
            </div>
          ) : (
            <div className="flex flex-col items-center gap-1 py-2 sm:py-3">
              <AlertCircle className="h-4 w-4 sm:h-5 sm:w-5 text-slate-700" />
              <p className="text-xs sm:text-sm text-slate-600">Not checked yet</p>
            </div>
          )}
        </div>
        ...
        <div
          className="flex items-center justify-between border-t border-slate-700/30 pt-2.5 sm:pt-3"
        ...
        >
          <div className="flex items-center gap-0.5">
            <motion.button
              ...
              onClick={onCheck}
              disabled={isChecking}
              className="p-1.5 sm:p-2 rounded-lg text-slate-500 hover:text-blue-400 hover:bg-blue-500/10
            ...
            <motion.button
              ...
              whileTap={{ scale: 0.9 }}
              onClick={onEdit}
              className="p-1.5 sm:p-2 rounded-lg text-slate-600 hover:text-slate-300 hover:bg-slate-700/40
                         transition-colors"
              title="Edit"
            >
            ...
            <motion.button
              ...
              whileTap={{ scale: 0.9 }}
              onClick={onDelete}
              className="p-1.5 sm:p-2 rounded-lg text-slate-600 hover:text-red-400 hover:bg-red-500/10
                         transition-colors"
              title="Delete"
            >
          ...
          <div className="flex items-center gap-1.5 sm:gap-2">
            {flight.last_checked && (
              <span className="text-[9px] sm:text-[10px] text-slate-600" title={flight.last_checked}>
                {formatDateTime(flight.last_checked)}
              </span>
            )}
            <MousePointerClick className="h-3 w-3 sm:h-3.5 sm:w-3.5 text-slate-700" />
          </div>
        </div>
      </GlassCard>
    </motion.div>
